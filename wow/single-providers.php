...
global $page_setting_class, $post;
global $taxonomy;
...
$CHfw_Provider = new CHfw_Provider($pid);
$url = home_url('/');
?>
    <main id="main-container" class="doctor-detailpage">
                ...
                <div class="row">
                    <nav class="breadCrumb">
                        ...
                        <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li>
                                <a itemprop="item" href="/providers/">
                                <span
                                        itemprop="name"><?php echo __("Providers", 'chfw-lang') ?></span>
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div id="Providers" class="<?php echo $doctor_main_info_container ?>">
                                        ...
                                        <div class="responsive-menu">
                                            <div class="menu-header">
                                                <ul id="menu-mobil-menu" class="menu">
                                                    <?php if (!empty($CHfw_Provider->myDepartmanLink)) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Departman', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <li>
                                                                    <a href="<?php echo $CHfw_Provider->myDepartmanLink ?>"><?php echo $CHfw_Provider->MyDepartmanInfo->name ?></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    <?php endif ?>
                                                    <?php if (!empty($CHfw_Provider->DepartmentSubCatInfo_forSubProviders())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Programs and Services', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Provider->DepartmentSubCatInfo_forSubProviders() as $DepartmentSubCatInfo_forSubProvider) {
                                                                    echo '<li><a href="' . get_the_permalink($CHfw_Provider->ProvidersID) . '">' . $DepartmentSubCatInfo_forSubProvider->post_title . '</a></li>';
                                                                }
                                                                ?>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    <?php if (!empty($CHfw_Provider->SubDepartmansList_ProgramsandServices)) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Related Programs and Services', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">

                                                                <?php
                                                                foreach ($CHfw_Provider->SubDepartmansList_ProgramsandServices as $ProgramsandServices) {
                                                    ...
                                                    <?php endif ?>
                                                    <?php if (!empty($CHfw_Provider->staffs())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'staff'); ?>"><?php _e('Doctors', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Provider->staffs() as $staff) {
                                                    ...
                                                    <?php
                                                    if (!empty($CHfw_Provider->locations())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'locations'); ?>"><?php _e('Locations', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Provider->locations() as $location) {
