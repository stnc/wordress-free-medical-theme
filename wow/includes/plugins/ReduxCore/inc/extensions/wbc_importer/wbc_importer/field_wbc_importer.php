...
if ( !class_exists( 'ReduxFramework_wbc_importer' ) ) {
    ...
    class ReduxFramework_wbc_importer {
        ...
        public function render() {
            ...
            $ch_fw_active_skin=get_option( $CHfw_themeCurrentSkin_option_name );
            ...
            if ( !empty( $this->field['wbc_demo_imports'] ) ) {
                ...
                foreach ( $this->field['wbc_demo_imports'] as $section => $imports ) {
                    ...
                    $ex_class="";
                    if ( $ch_fw_active_skin==$imports['directory'] ) {
                       $ex_class='active_skin';
                    }
                    ...
                    echo '<div class="wrap-importer theme '.$extra_class.' '.$ex_class.'" data-demo-id="'.esc_attr( $section ).'"  data-nonce="' . $nonce . '" id="' . $this->field['id'] . '-custom_imports">';
