...
?>
      ...
      <div id="post-<?php the_ID(); ?>" class="col-md-3 col-sm-6 col-xs-6 col-ms-12 post left-align">
         <div class="doc-list-info-box border-radius">
            ...
            <div class="doc-container">
               <div class="doc-head">
                  <a href="<?php the_permalink() ?>">
                     ...
                     <a href="<?php the_permalink() ?>"> <h2><?php echo get_the_title() ?></h2>
