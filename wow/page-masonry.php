...
<main id="main-container" class="indexpage page-masonry-top">
        ...
        <div class="row">
            ...
            <div id="<?php echo $page_setting_class->layout_id_content ?>"
                ...
                <div class="page-masonry" id="bodyheader">
                    <div
                            class="ajax-page-content boxed-content contentbar <?php echo $header_setting['center_class'] ?>">
                        <section class="list-blog-wrapper page-masonry-blog blog <?php echo $post_border_class ?>">
                            <?php
