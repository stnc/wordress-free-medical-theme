...
$CHfw_Conditions = new CHfw_Conditions($pid);
$url = home_url('/');
?>
                    ...
                    <nav class="breadCrumb">
                        ...
                        <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li>
                                ...
                                <span
                                        itemprop="name"><?php echo __("Conditions", 'chfw-lang') ?></span>
                                </a>
                        ...
                        <div id="doctorInfo" class="col-md-7 <?php echo $doctor_main_info_container?>">
                            <div class="breadcrumb-Sum">
                                <h1 class="breadcrumb-InfoName">
	                                <span class="doctorTitle"><br><?php echo get_the_title() ?></span>
                                </h1>
                                <a href="#hrefappoi"
                                        ...
                                        <div class="responsive-menu">
                                            <div class="menu-header">
                                                <ul id="menu-mobil-menu" class="menu">
                                                    <?php if (!empty($CHfw_Conditions->myDepartmanLink)) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Departman', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <li>
                                                                    <a href="<?php echo $CHfw_Conditions->myDepartmanLink ?>"><?php echo $CHfw_Conditions->MyDepartmanInfo->name ?></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    <?php endif ?>
                                                    <?php if (!empty($CHfw_Conditions->DepartmentSubCatInfo_forSubProviders())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Programs and Services', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Conditions->DepartmentSubCatInfo_forSubProviders() as $DepartmentSubCatInfo_forSubProvider) {
                                                                    echo '<li><a href="' . get_the_permalink($CHfw_Conditions->ProvidersID) . '">' . $DepartmentSubCatInfo_forSubProvider->post_title . '</a></li>';
                                                                }
                                                                ?>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    <?php if (!empty($CHfw_Conditions->SubDepartmansList)) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Related Programs and Services', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Conditions->SubDepartmansList as $ProgramsandServices) {
                                                    ...
                                                    <?php endif ?>
                                                    <?php if (!empty($CHfw_Conditions->staffs())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'staff'); ?>"><?php _e('Doctors', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Conditions->staffs() as $staff) {
                                                    ...
                                                    <?php if (!empty($CHfw_Conditions->treatments())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'resource_family'); ?>"><?php _e('Resource Family', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Conditions->treatments() as $provider) {
                                                    ...
                                                    <?php endif ?>
                                                    <?php
                                                    if (!empty($CHfw_Conditions->locations())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'locations'); ?>"><?php _e('Locations', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_Conditions->locations() as $location) {
