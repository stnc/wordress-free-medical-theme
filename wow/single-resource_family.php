...
$CHfw_ResourceFamily = new CHfw_ResourceFamily($pid);
$url = home_url('/');
?>
    <main id="main-container" class="doctor-detailpage">
                ...
                <div class="row">
                    <nav class="breadCrumb">
                        ...
                        <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                            ...
                            <li>
                                <a itemprop="item" href="/resource_family/">
                                <span
                                        itemprop="name"><?php echo __("Resource Family", 'chfw-lang') ?></span>
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div id="Resource-Family" class="<?php echo $doctor_main_info_container ?>">
                    <div class="page-bloglist" id="bodyheader">
                        <div class="ajax-page-content boxed-content clearfix bloglist-page-top contentbar ">
                            <section id="doctor-detail-page" class="doctor-detail-page event-detail-page  <?php echo $post_border_class ?>">
                                        ...
                                        <div class="responsive-menu">
                                            <div class="menu-header">
                                                <ul id="menu-mobil-menu" class="menu">
                                                    <?php if (!empty($CHfw_ResourceFamily->myDepartmanLink)) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Departman', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <li>
                                                                    <a href="<?php echo $CHfw_ResourceFamily->myDepartmanLink ?>"><?php echo $CHfw_ResourceFamily->MyDepartmanInfo->name ?></a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    <?php endif ?>
                                                    <?php if (!empty($CHfw_ResourceFamily->DepartmentSubCatInfo_forSubProviders())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Programs and Services', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_ResourceFamily->DepartmentSubCatInfo_forSubProviders() as $DepartmentSubCatInfo_forSubProvider) {
                                                                    echo '<li><a href="' . get_the_permalink($CHfw_ResourceFamily->ProvidersID) . '">' . $DepartmentSubCatInfo_forSubProvider->post_title . '</a></li>';
                                                                }
                                                                ?>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    <?php if (!empty($CHfw_ResourceFamily->SubDepartmansList)) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'departmans'); ?>"><?php _e('Related Programs and Services', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">

                                                                <?php
                                                                foreach ($CHfw_ResourceFamily->SubDepartmansList_ProgramsandServices as $ProgramsandServices) {
                                                    ...
                                                    <?php endif ?>
                                                    <?php if (!empty($CHfw_ResourceFamily->staffs())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'staff'); ?>"><?php _e('Doctors', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_ResourceFamily->staffs() as $staff) {
                                                    ...
                                                    <?php if (!empty($CHfw_ResourceFamily->ResourceFamily())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'resource_family'); ?>"><?php _e('Resource Family', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_ResourceFamily->ResourceFamily() as $provider) {
                                                    ...
                                                    <?php endif ?>
                                                    <?php
                                                    if (!empty($CHfw_ResourceFamily->locations())) : ?>
                                                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children">
                                                            <a href="<?php echo esc_url($url . 'locations'); ?>"><?php _e('Locations', 'chfw-lang') ?></a>
                                                            <ul class="sub-menu">
                                                                <?php
                                                                foreach ($CHfw_ResourceFamily->locations() as $location) {
