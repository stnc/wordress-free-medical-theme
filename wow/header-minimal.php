<?php
global $CHfw_rdx_options, $page_setting_class, $CHfw_select_skin; $headerClass = "";?>
<!DOCTYPE html>
...
<body id="<?php echo $CHfw_select_skin ?>" <?php body_class("header-minimalbody"); ?>>
...
<div id="wrapper" class="toggled1 <?php echo $page_setting_class->siteBodyLayoutSetting(); ?>">
    <header class="header-container  header-minimal <?php echo $headerClass ?>">
        <?php
        if ($CHfw_select_skin == 'MinimalSkin') {
            get_template_part("includes/header-menu/desktop-menu_minimal");
        } else {
