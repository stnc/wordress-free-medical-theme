...
<body id="<?php echo $CHfw_select_skin ?>" <?php body_class("header-minimalfixedbody"); ?>>
...
<div id="wrapper" class="toggled1" <?php echo $page_setting_class->siteBodyLayoutSetting(); ?>>
	<header class="header-container header-fixed  header-minimal full-width <?php echo $headerClass ?>">
		<?php
